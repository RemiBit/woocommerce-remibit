...
/*
   ...
   Author URI: https://github.com/RemiBit/woocommerce-remibit
   License: Under GPL2
   ...
   */
   class WC_Tech_Autho extends WC_Payment_Gateway 
   {
      ...
      public function __construct(){
         ...
         $this->id               = 'authorize';
         $this->method_title     = __('RemiBit', 'tech');
         ...
         $this->liveurl          = 'https://app.remibit.com/pay';
         $this->testurl          = 'https://app.remibit.com/pay';
      ...
      'x_currency_code'      => $order->get_currency(),
        ...
        if($this->mode == 'true'){
         ...
         $html_form    = '<form action="'.$processURI.'" method="post" id="authorize_payment_form">' 
               ...
               . '<input type="submit" class="button" id="submit_authorize_payment_form" value="'.__('Pay via RemiBit', 'tech').'" /> <a class="button cancel" href="'.$order->get_cancel_order_url().'">'.__('Cancel order &amp; restore cart', 'tech').'</a>'
...
function authsim_action_links ( $links ) {
   $authsim_links = array(
      ...
      '<a href="http://talk.remibit.com" target="_blank">Support</a>',
      '<a href="https://app.remibit.com/login" >Visit Dashboard</a>'
